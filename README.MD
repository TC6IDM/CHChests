...
1. Crystal Hollows Chest Finder
2. Titanium Finder
3. Trapper Helper
4. Server Finder
...
* Default Keybind for scanning for titanium: ``+``
* Default Keybind for trapper helper: ``*``
* command for Server Finder: /chc [locate/stop] <//server//>
...
make it compatable with lconfig
